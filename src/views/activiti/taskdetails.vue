<template>
  <div class="app-container">
    ...
    <el-row class="el-row-item">
      ...
      <el-col :span="12">{{ $t('task.assignee') }}：{{ this.$route.query && this.$route.query.assignee }}</el-col>
    </el-row>
    <el-row class="el-row-item">
      <el-col :span="12">{{ $t('task.claimTime') }}：{{ this.$route.query && this.$route.query.claimTime | parseTime('{y}-{m}-{d} {h}:{i}:{s}') }}</el-col>
